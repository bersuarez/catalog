...
User1 = User(name="Juan Perez",
             email="juan@perez.com",
             picture="https://i.pinimg.com/"
             "originals/63/a5/e8/63a5e8ee8cdcfab2f952bcd46a73e5c4.jpg")
session.add(User1)
session.commit()

User2 = User(name="Mr Robot",
             email="mr@robot.com",
             picture="https://www.avaus.fi/"
             "wp-content/uploads/2015/08/"
             "AMI_newsletter_blog_strategia_tiimi_850x650.jpg")
session.add(User2)
session.commit()

User3 = User(name="Obama",
             email="mr@barack.com",
             picture="https://pbs.twimg.com/"
             "profile_images/822547732376207360/5g0FC8XX_400x400.jpg")
session.add(User3)
session.commit()

dummyItem1 = Event(name='Trip',
                   description="This year we decided to go to Morocco,"
                   "mainly because it seemed inexpensive, but after the"
                   "vacation we were definitely in love with the place.",
...
dummyItem2 = Event(name='Retreat',
                   description='Eye oppening retreat to a marvelous place',
...
dummyItem3 = Event(name='Cool party',
                   description='Got to hang out with my pals',
